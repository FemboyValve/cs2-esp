...
void HardwareRenderer::RenderText(int x, int y, const char* text, COLORREF textColor, int textSize)
{
...
ComPtr<IDWriteTextFormat> HardwareRenderer::GetOrCreateTextFormat(int textSize)
{
...
void HardwareRenderer::RenderTextSimple(int x, int y, const wchar_t* text, UINT32 textLength, COLORREF textColor, int textSize)
{
...
HRESULT HardwareRenderer::CreateDeviceResources()
{
    if (m_pRenderTarget) {
...
HRESULT HardwareRenderer::Initialize(HWND hWnd)
{
    std::lock_guard<std::mutex> lock(m_renderMutex);
...
void HardwareRenderer::RenderTextFallback(int x, int y, const wchar_t* text, UINT32 textLength,
...
void HardwareRenderer::RenderTextWithOutline(int x, int y, IDWriteTextLayout* textLayout, COLORREF textColor)
{
